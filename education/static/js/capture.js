...
const captureScreen = async () => {
    try {
        ...
        video.addEventListener("loadedmetadata", () => {
            ...
            const screenshotDataInput = document.querySelector("#screenshot_data");
            screenshotDataInput.value = screenshotData 
            
            
            // passing canvas data url as screenshot preview src
            screenshotPreview.querySelector("img").src = canvas.toDataURL('image/png');
